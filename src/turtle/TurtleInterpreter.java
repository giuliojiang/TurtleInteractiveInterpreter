...
public class TurtleInterpreter {
	...
	/**
	 * Processes all the commands from the
	 * input source
	 * 
	 */
	public void process()
	...
	private void processPaper()
	{
		...
		{
			System.out.println(
					"Error in PAPER, parameter WIDTH " +
							"cannot be negative."
					);
		...
		{
			System.out.println(
					"Error in PAPER, parameter HEIGHT " +
							"cannot be negative."
					);
	...
	private void processMove()
	{
		...
		{
			System.out.println(
					"Error in MOVE, parameter DISTANCE " +
							"cannot be negative."
					);
